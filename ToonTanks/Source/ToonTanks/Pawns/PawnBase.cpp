...
{
	// Update the TurretMesh rotation to face towards the LookAtTarget passed in from the Child Classes
...
void APawnBase::HandleDestruction()
{
	...
	// -- PawnTank - Infor GameMode Player died -> Then Hide(all components && stop movement input
}